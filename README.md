...
| [`default-review`](default-review/) | The default `tessl review` rubric – rubric-based LLM judges for a skill's description and content, the same reviewer `tessl review` uses out of the box. Score skills against it, or fork it into a custom rubric | [![default-review version](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Ftesslio%2Fproduct-plugins%2Fmain%2Fdefault-review%2F.tessl-plugin%2Fplugin.json&query=%24.version&label=tessl&color=blue&prefix=v)](https://tessl.io/registry/tessl/default-review) [![default-review evals](https://img.shields.io/endpoint?url=https%3A%2F%2Fapi.tessl.io%2Fv1%2Fbadges%2Ftessl%2Fdefault-review)](https://tessl.io/registry/tessl/default-review/evals) |

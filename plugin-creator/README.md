...
| `plan-composition` | Decide the shape: a single skill, or a plugin with the right mix of skills, rules, hooks, and MCP servers. |
| `build-composition` | Create it, scaffolding with the CLI and authoring any hook or MCP configuration the plan requires. |
